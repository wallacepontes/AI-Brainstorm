...
- [The Big LLM Architecture Comparison](#the-big-llm-architecture-comparison)
  ...
  - [NotebookLM](#notebooklm)
    - [MindMap](#mindmap)
    - [LLM Architecture 2025: Efficiency \& Specialization](#llm-architecture-2025-efficiency--specialization)
  - [Videos](#videos)
...
### [MindMap](img/Evolution_LLM_Architectures_2025_MindMap.png)

```mermaid
mindmap
  LLM Architecture Comparison - 2025
    DeepSeek v3/R1
      MLA
      MoE
    OLMo 2
...
### LLM Architecture 2025: Efficiency & Specialization

[![LLM_Architecture_2025_Efficiency_and_Specialization](img/LLM_Architecture_2025_Efficiency_and_Specialization.png)](pdf/LLM_Architecture_2025_Efficiency_and_Specialization.pdf)
